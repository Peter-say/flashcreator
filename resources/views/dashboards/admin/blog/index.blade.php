                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spapostg: 0; width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="center">
                                        <a href="" class="btn btn-warning" data-toggle="modal" data-target="#edit-{{$post->id}}"><i class="fa fa-edit"></i></a>
                                                ...
                                                <form action="" method="post" enctype="multipart/form-data">@csrf @method('put')
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input type="text" class="form-control" id="" value="{{ $post->name }}" name="name" placeholder="name">
                                                        </div>

                                                        <div class="form-group col-md-6">
                                                            <label>Description</label>

                                                                <textarea name="description" required rows="5" cols="40" class="form-control" required value="">{{ $post->description }}</textarea>
                                                        </div>
