...
@section('content')
    ...
    <!--  BEGIN NAVBAR  -->
    <div class="sub-header-container pt-5">
    ...
    <div class="main-container" id="container pt-5">

        <div class="overlay"></div>
        <div class="search-overlay"></div>

        <!--  BEGIN SIDEBAR  -->
        <div class="sidebar-wrapper sidebar-theme pt-5">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        <a href="{{ route('post-page')}}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
