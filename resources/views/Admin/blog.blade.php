                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spapostg: 0; width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="center">
                                        <a href="" class="btn btn-warning" data-toggle="modal" data-target="#edit-{{$blogs->id}}"><i class="fa fa-edit"></i></a>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{route('admin.blogs.update',$blogs->id)}}" method="post" enctype="multipart/form-data">@csrf @method('put')
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <select name="blog_category_id" id="role" class="form-control"  required>
                                                                ...
                                                                @foreach ($categories as $cat)
                                                                    <option value=" {{!empty($category->id) }}" {{ old('blog_category_id') == $category->id ? 'selected' : ''}}>{{ $category->title }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <label>Description</label>
                                                                ...
                                                                <textarea name="description" rows="5" cols="40" class="form-control" value="">{{ $post->description }}</textarea>
                                                        </div>
                                ...
                                <div class="modal fade" id="delete">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                <form action="{{route('admin.blogs.destroy',$blog->id)}}" method="post">{{csrf_field()}} {{method_field('DELETE')}}
                ...
                <div class="modal-body">
                    ...
                    @csrf
                        <div class="form-row">
                            <div class="form-group{{ $errors->has('category_id') ? ' has-error' : '' }} col-md-6">
                                ...
                                <select name="blog_category_id" id="blog_category_id"  class="form-control" autofocus>
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{!empty($category->id) ?  $category->name :''}}"></option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-12">
                                <label for=""></label>
                                <input type="text" class="form-control @error('full_name') is-invalid @enderror" id="" name="name" placeholder="Name">
                            </div>

                            <div class="form-group col-md-12">

                                <textarea name="description" rows="5" cols="40" class="form-control  @error('full_name') is-invalid @enderror" value="">{{old('description')}}</textarea>
